...
public class ApiConstants {
    ...
    public static final String MY_ADDRESS = BASE_URL + "get_my_addresses.php";
    public static final String ADD_ADDRESS = BASE_URL + "addaddress.php";
    public static final String DELETE_ADDRESS = BASE_URL + "delete_address.php";
    public static final String UPDATE_ADDRESS = BASE_URL + "update_address.php";
    public static final String INSERT_ADDRESS_SINGLEPAGECHECKOUT = BASE_URL + "insert_address_singlecheckout.php";
    ...
    public static final String INSERT_REVIEWORDER = BASE_URL + "insert_review_singlecheckout.php";
